...
function buyCookiePropaganda() {
	var cookiepropagandaCost = Math.floor(100 * Math.pow(1.1, cookiepropagandas)); //works out the cost of this cookiepropaganda
	...
	var nextCost = Math.floor(100 * Math.pow(1.1, cookiepropagandas)); //works out the cost of the next cookiepropaganda
