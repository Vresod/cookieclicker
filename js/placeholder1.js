...
function buyGrandma(){
    var cookiecowboyCost = Math.floor(25 * Math.pow(1.1,cookiecowboys));     //works out the cost of this cookiecowboy
    ...
    var nextCost = Math.floor(25 * Math.pow(1.5,cookiecowboys));       //works out the cost of the next cookiecowboy
    document.getElementById('cookiecowboyCost').innerHTML = nextCost;  //updates the cookiecowboy cost for the user
};

window.setInterval(function (){

  cookieClick(cookiecowboys * 2);
